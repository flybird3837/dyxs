...
@section('title', isset($project) ? '修改党组织' : '添加党组织')
@section('content-header', isset($project) ? '修改党组织' : '添加党组织')
    ...
    <div class="row">
        <div class="col-lg-12">
            <ul class="breadcrumb">
                ...
                <li class="active">{{isset($project) ? '修改党组织' : '添加党组织'}}</li>
            </ul>
        ...
        <div class="col-lg-12">
            <form class="form-horizontal" data-validate="parsley" style="margin-bottom: 60px;" method="POST"
                ...
                <section class="panel panel-default">
                    <header class="panel-heading"><strong>{{isset($project) ? '修改党组织' : '添加党组织'}}</strong></header>
                    <div class="panel-body">

                        <div class="form-group {{$errors->has('name') ? 'has-error' : ''}}">
                            <label class="col-sm-3 control-label">党组织名称</label>
                            <div class="col-sm-9">
